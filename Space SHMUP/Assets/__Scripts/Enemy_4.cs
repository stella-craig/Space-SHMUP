...
public class Enemy_4 : Enemy
{
    ...
    public float duration = 4; // Duratio of interpolation movement
    ...
    private void Start()
    {
        ...
        // Initialy set p0 & p1 to the current position (from Main.SpawnEnemy())
        p0 = p1 = pos;
        InitMovement();
    }
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        if(p!= null)
        {
            ...
            {
                // Find the GameObjecct of this Enemy_4 that was actually hit
